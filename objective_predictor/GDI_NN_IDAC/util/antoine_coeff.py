...
# - The corresponding implementation can be found here: https://github.com/zavalab/ML/tree/master/SolvGNN
# - Qin et al. further referenced following repository: https://github.com/oscarcontrerasnavas/NIST-web-book-scraping/blob/master/saturation.py
#
#*********************************************************************************
