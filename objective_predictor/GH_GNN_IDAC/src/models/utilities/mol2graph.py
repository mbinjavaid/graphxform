...
def sys2graph(df, mol_column_1, mol_column_2, target, y_scaler=None, single_system=False, silent=False):
    '''
    ...
    for y, solv, solu in tqdm(zip(ys, solvents, solutes), total=len(ys), disable=silent):
...
def cat_dummy_graph(batch, device=None):
